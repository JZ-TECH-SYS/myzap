...
const Mensagens = require('../functions/Venom/mensagens.js');
const Auth = require('../functions/Venom/auth.js');
const config = require('../config');
const { checkParams } = require('../middlewares/validations.js');
const { checkNumber } = require('../middlewares/checkNumber.js');
